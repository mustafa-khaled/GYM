...
function NavLinks({ activeSidebar, closeSidebar }) {
  return (
    ...
    >
      <ul className="flex h-[70vh] flex-col items-center justify-between pt-[20px] md:h-auto md:flex-row md:justify-start md:gap-[10px] md:pt-0 lg:gap-[20px] xl:gap-[50px]">
        {links?.map((link) => {
          return (
            <li key={link.href}>
              <NavLink
